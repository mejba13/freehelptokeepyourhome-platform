...
class extends Component {
    ...
    public function mount(Testimonial $testimonial): void
    {
        ...
        $this->author_location = $testimonial->author_location ?? '';
    ...
    {
        $this->testimonial->update($this->validate());
                    ...
                    <div class="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-900">
                        <div class="space-y-4">
                            <flux:field>
                                ...
                                <flux:input wire:model="author_name" />
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                <flux:field>
                                    ...
                                    <flux:input wire:model="author_title" />
                                    <flux:error name="author_title" />
                                </flux:field>

                                <flux:field>
                                    <flux:label>{{ __('Location') }}</flux:label>
                                    <flux:input wire:model="author_location" />
